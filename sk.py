...
while 1:
    ...
    menubar.add_command(label="start over",command=bord.destroy)
    menubar.add_command(label="map",command=partial(new_window_map,Buttons))# menu=filemenu)
